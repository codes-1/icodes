...
public class ViewerServletContextListener implements ServletContextListener {
	...
	private static boolean haveLoadRepInfo = false;
	/*
	 * (non-Javadoc)   
	 * 
	...
	public static boolean isHaveLoadRepInfo() {
		return haveLoadRepInfo;
	}

	public static void setHaveLoadRepInfo(boolean haveLoadRepInfo) {
		ViewerServletContextListener.haveLoadRepInfo = haveLoadRepInfo;
	}
}
