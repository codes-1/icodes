...
public class TestCaseLibraryDetail implements JsonInterface{
	...
	*/
	...
	public TestCaseLibraryDetail(String testCaseId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TestCaseLibraryDetail))
			return false;
		TestCaseLibraryDetail castOther = (TestCaseLibraryDetail) other;
