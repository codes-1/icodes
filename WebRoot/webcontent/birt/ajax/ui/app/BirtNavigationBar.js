...
BirtNavigationBar.prototype = Object.extend( new AbstractUIComponent( ),
{
	...
	__cb_bind : function( data )
	{
		...
		$("mypmPageSize").innerHTML = totalPage;
	...
	__cb_installEventHandlers : function( )
	{
		...
		// Observe "onblur" event
		this.onblur_closure = this.__neh_onblur.bindAsEventListener(this);
		Event.observe($('gotoPage'), 'blur', this.onblur_closure, false);
	},
	...
	__gotoGage : function( )
	{
		...
		{			
			...
			document.getElementById("mypmMessage").innerHTML = Constants.error.invalidPageNumber;
			oGotoPage.focus( );
		}
	},
