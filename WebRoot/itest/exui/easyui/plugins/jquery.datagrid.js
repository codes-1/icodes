...
var _1=0;
function _2(a,o){
return $.exui.indexOfArray(a,o);
};
function _3(a,o,id){
$.exui.removeArrayItem(a,o,id);
};
function _4(a,o,r){
$.exui.addArrayItem(a,o,r);
};
function _5(_6,aa){
...
var ss=["<style type=\"text/css\" exui=\"true\">"];
...
ss.push("</style>");
$(ss.join("\n")).appendTo(cc);
cc.children("style[exui]:not(:last)").remove();
},getRule:function(_10){
var _11=cc.children("style[exui]:last")[0];
...
var popts = {total:0,pageNumber:_5b.pageNumber,pageSize:_5b.pageSize,pageList:_5b.pageList,onSelectPage:function(_64,_65){
_5b.pageNumber=_64||1;
_5b.pageSize=_65;
_62.pagination("refresh",{pageNumber:_64,pageSize:_65});
_bf(_59);
}};
if(_5b.layout&&_5b.layout.length){
	popts.layout = _5b.layout;
}
_62.pagination(popts);
...
var _1bd=$("<input type=\"text\" class=\"datagrid-editable-input form-control\">").appendTo(_1bb);
...
var _1c7=$("<textarea class=\"datagrid-editable-input form-control\"></textarea>").appendTo(_1c5);
...
var _1d6=$("<input type=\"text\" class=\"datagrid-editable-input form-control\">").appendTo(_1d4);
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",resizeEdge:5,autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",emptyMsg:"",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],layout:null,queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollOnSelect:true,scrollbarSize:18,rownumberWidth:30,editorHeight:26,headerEvents:{mouseover:_82(true),mouseout:_82(false),click:_86,dblclick:_8d,contextmenu:_93},rowEvents:{mouseover:_96(true),mouseout:_96(false),click:_9e,dblclick:_a9,contextmenu:_ae},rowStyler:function(_253,_254){
