...
if(!_3.grid){
var _9=$(_2).combo("panel").css('overflow', 'hidden');
...
$.exui.addArrayItem(_c,_d[_4.idField]);
});
}
_16(_2,_c);
...
function _20(_21,a){
var _22=$.exui.getArrayItem(a,_1a.idField,_21);
...
if(q){
var v=undefined;
$.exui.forEach(_29,true,function(row){
...
if(v==undefined){
$.exui.forEach(_26.mappingRows,false,function(row){
...
if($.exui.indexOfArray(_2d.mappingRows,_2d.idField,v)>=0){
$.exui.addArrayItem(vv,v);
}
});
...
$.exui.addArrayItem(_35.mappingRows,_35.idField,_36);
...
$.fn.combotreegrid.defaults=$.extend({},$.fn.combo.defaults,$.fn.treegrid.defaults,{height:34,editable:false,singleSelect:true,limitToGrid:false,unselectedValues:[],mappingRows:[],mode:"local",textField:null,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
