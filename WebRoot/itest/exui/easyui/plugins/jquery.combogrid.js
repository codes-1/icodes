...
(function($) {
	function _1(_2) {
		...
		var _a = $(_2).combo("panel").css('overflow', 'hidden'); //var _a = $(_2).combo("panel");
		if (!_5) {
	...
	function _20(_27, _28, _29) {
		...
		function _38(_39, a) {
			var _3a = $.exui.getArrayItem(a, _2b.idField, _39);
	...
	function _46(_47) {
		...
		$.map(_49.unselectedValues, function(v) {
			if ($.exui.indexOfArray(_49.mappingRows, _49.idField, v) >= 0) {
	...
	$.fn.combogrid = function(_4c, _4d) {
		...
		return this.each(function() {
			...
			if (_4f) {
				...
				_4f = $.data(this, "combogrid", {
					options: $.extend({}, $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _4c)
				});
			}
			_1(this);
		});
				...
				if ($.isArray(_52)) {
					_52 = $.map(_52, function(_54) {
						if (_54 && typeof _54 == "object") {
							$.exui.addArrayItem(_53.mappingRows, _53.idField, _54);
