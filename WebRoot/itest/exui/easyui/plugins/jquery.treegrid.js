...
var _2c=$.exui.indexOfArray(_2b,_2a.idField,_2a.lastSelectedIndex);
var _2d=$.exui.indexOfArray(_2b,_2a.idField,_25);
...
if(_3c==0){
$.exui.removeArrayItem(_3e,_3f.idField,row[_3f.idField]);
}else{
$.exui.addArrayItem(_3e,_3f.idField,row);
}
};
function _38(_40,row,_41){
var _42=_41?1:0;
_3a(_40,row,_42);
$.exui.forEach(row.children||[],true,function(r){
_3a(_40,r,_42);
});
};
...
var _79=[];
$.exui.forEach(_77,true,function(_7a){
_79.push(_7a);
});
return _79;
};
...
var _83=_82.options;
var _84=null;
$.exui.forEach(_82.data,true,function(_85){
...
$.exui.removeArrayItem(_b8.checkedRows,_b9.idField,_b7);
_1f(_b6);
if(_ba){
...
_e0=_e0||"checked";
var _e1=[];
$.exui.forEach(jq.data("treegrid").checkedRows,false,function(row){
...
var flag=0;
var crow=$.exui.getArrayItem(_102.checkedRows,opts.idField,row[opts.idField]);
if(crow){
flag=crow.checkState=="checked"?1:2;
row.checkState=crow.checkState;
row.checked=crow.checked;
$.exui.addArrayItem(_102.checkedRows,opts.idField,row);
}else{
var prow=$.exui.getArrayItem(_102.checkedRows,opts.idField,row._parentId);
...
if(row.checked){
$.exui.addArrayItem(_102.tmpIds,row[opts.idField]);
}
}
