...
(function($) {
    ...
    function _9(_a) {
        ...
        function _f(_11) {
            ...
            _d.removeClass("tooltips-top tooltips-bottom tooltips-left tooltips-right").addClass("tooltips-" + _c.position);
            var _12, top;
    ...
    function _15(_16, e) {
        ...
        _17.showTimer = setTimeout(function() {
            ...
            var _1a = tip.children(".tooltips-arrow-outer");
            var _1b = tip.children(".tooltips-arrow");
    ...
    function _19(_1f, _20) {
        ...
        _21.tip.children(".tooltips-content").html(cc);
    ...
    $.fn.tooltip.methods = {
        ...
        arrow: function(jq) {
            return jq.tooltip("tip").children(".tooltips-arrow-outer,.tooltips-arrow");
        },
        show: function(jq, e) {
