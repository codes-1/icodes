...
<div class="tabwapper" >
	...
	<div id="roleInnerDiv" >
		...
		<div class="tools" style="padding-top: 10px;">
		    <button type="button" class="btn btn-default" id="queryInnerData"><i class="glyphicon glyphicon-search"></i>查询</button> 
			<button type="button" class="btn btn-default" id="delInnerData"><i class="glyphicon glyphicon-remove"></i>从角色中删除</button>
...
<script src="<%=request.getContextPath()%>/itest/js/roleManager/roleUserManager.js" type="text/javascript" charset="utf-8"></script>