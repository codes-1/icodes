...
<div class="tools">
	...
	<!-- <div style="float:right"> -->
		<button type="button" class="btn btn-default" style="border: 1px solid #1E7CFB;color: #1E7CFB;" onclick="concernMissions()"><i class="glyphicon glyphicon-pencil"></i>关注</button>
	<!-- </div> -->
</div><!--/.top tools area-->
<!-- 其他任务显示列表 -->
...
<script src="<%=request.getContextPath()%>/itest/js/otherMission/otherMissionAll.js" type="text/javascript" charset="utf-8"></script>